...
public class ValidationMethods {
	...
	public static String getString(Scanner scnr, String prompt) {
		...
		do {
			...
			if (tempString.equals("horror") || tempString.equals("animated") || tempString.equals("drama") || tempString.equals("scifi")) {
				answer = tempString;
			} else {
	...
	public static String getString2(Scanner scnr, String prompt) {
		System.out.println(prompt);
		String tempString = "";
		String answer = "";
		do {
